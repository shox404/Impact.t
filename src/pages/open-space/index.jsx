...
function Index(props) {
    return (
        <div className="w-full h-auto  ">
            ...
            <div className="flex w-full h-auto bg-[#EBEBEB]  items-center justify-center gap-6 sm:flex-col">
                <div className="w-[440px] h-[585px] bg-[#D1D1D1] border rounded-[20px] flex flex-col  p-8 sm:w-[90%] sm:h-[520px]">
                    <h3 className=" text-[#2D2D2D] mt-4 text-[28px] sm:text-[20px]">Flex Plan</h3>
                    <h2 className="text-[48px] text-[#2D2D2D] mt-1 sm:text-[25px]">1,7 mln uzs <span
                    ...
                    <div className="mt-8 w-full flex flex-col gap-4">
                        ...
                        </p>   <p className="flex items-center gap-2 text-[16px] text-[#797979] w-[450px] sm:w-[80%]">
                            <img className="w-[16px] h-[17px]" src={Chek} alt=""/>
                        Printer 15 pages
                        </p>
                        <p className="flex items-center gap-2 text-[16px] text-[#797979]">
                ...
                <div className="w-[440px] h-[585px] bg-[#2D2D2D] border rounded-[20px] flex flex-col  p-8 sm:w-[90%] sm:h-[560px]">
                    <h3 className=" text-white mt-4 text-[28px] sm:text-[20px]">Flex Plan</h3>
                    <h2 className="text-[48px] text-white mt-1 sm:text-[25px]">2,2 mln uzs <span
                        className="text-[#797979] text-[20px] sm:text-[18px]">/Month</span></h2>
                    <div className="mt-8 w-full flex flex-col gap-4">
                        <p className="flex items-center gap-2 text-[16px] text-[#797979]">
                            <img className="w-[16px] h-[17px]" src={Chek} alt=""/>
                    ...
                    <button
                        className="w-[347px] mt-[130px] ml-3 h-[60px] bg-[#ffffff] rounded-[90px] text-black text-[19px] sm:mt-[20px]  sm:mb-[-20px] sm:w-[90%]">
                        Booking space
                    </button>
                </div>
