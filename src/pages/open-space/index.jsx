...
function Index(props) {
    return (
        <div className="w-full h-auto  ">
            ...
            <div className={"flex w-full h-auto justify-center items-center gap-10 bg-[#EBEBEB] sm:flex-wrap "}>
                <div
                ...
                <div
                    ...
                    <div className="mt-8 w-full flex flex-col gap-4">
                        ...
                        <p className="flex items-center gap-2 text-[16px] text-[#797979] w-[450px] sm:w-[95%]">
                            <img className="w-[16px] h-[17px]" src={Chek} alt=""/>
                    ...
                    <button
                        className=" sm:w-[90%] w-[347px] mt-[90px]  ml-3 h-[60px] bg-[#373737] rounded-[90px] text-white text-[19px]">
                        Booking space
                    </button>
                < /div>
