    ...
    return (
        <div>
            ...
            <div className='h-auto pb-32 w-full bg-backgroundImageGallery bg-cover bg-no-repeat rounded-none'>
                <h1 className='pt-60 pr-10 text-[95px] sm:text-6xl lg:text-center lg:w-full lg:px-10 sm:w-full sm:px-5 sm:pt-48 sm:text-center pl-14 w-2/3 text-white'>Discover all the
                    highlights we have 
                    to offer!</h1>
            </div>
            <div className='w-full h-auto flex sm:flex-wrap lg:flex-wrap lg:pt-14 sm:gap-2 sm:pt-5 items-center px-14 sm:px-5 gap-5 py-16 sm:py-5 pt-40 '>
                ...
                <Link to={'/about-studio'}><button className='w-auto px-12 sm:px-7 sm:py-3 h-auto py-4 rounded-full bg-[#DFDFDF] text-[#2D2D2D] hover:bg-[#FF5722] hover:text-white'>Office</button>
                </Link>
                <Link><button className='w-auto px-12 sm:px-7 sm:py-3 h-auto py-4 rounded-full bg-[#DFDFDF] text-[#2D2D2D] hover:bg-[#FF5722] hover:text-white'>Meeting room</button>
                </Link>
                <Link><button className='w-auto px-12 sm:px-7 sm:py-3 h-auto py-4 rounded-full bg-[#DFDFDF] text-[#2D2D2D] hover:bg-[#FF5722] hover:text-white'>Terrace</button>
                </Link>
                <Link to={'/gallery'}><button className='w-auto px-12 sm:px-7 sm:py-3 h-auto py-4 rounded-full bg-[#DFDFDF] text-[#2D2D2D] hover:bg-[#FF5722] hover:text-white'>Art gallery</button>
                </Link>
                <Link><button className='w-auto px-12 sm:px-7 sm:py-3 h-auto py-4 rounded-full bg-[#DFDFDF] text-[#2D2D2D] hover:bg-[#FF5722] hover:text-white'>Interior</button>
                </Link>
            </div>
