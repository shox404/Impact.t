...
import Chek3 from "../offece/🎨-Color.png";
        ...
        <div className="w-full h-auto bg-[#EBEBEB]">
            ...
            <div className="flex w-full h-auto pb-20 gap-80 pt-32 bg-[#EBEBEB] sm:flex-col lg:flex-col">
                ...
                <div className="sm:mt-[-280px] sm:ml-[30px] lg:ml-[210px]">
                    <h2 data-aos='fade-down' className="text-[#8D8D8D] text-[32px] lg:mt-[-280px] ml-[-105px]">5+ Meeting rooms</h2>
                    <p data-aos='zoom-out' className="text-[20px] sm:w-[80%] text-[#2D2D2D] w-[390px] mt-8 ml-[-105px]">
            ...
            <div className={"w-full flex-wrap gap-1  h-[230vh]   "}>
                <div data-aos='zoom-out-up' className="w-[843px] h-[447px] bg-white ml-[490px] rounded-[20px] ">

                    <img src={Conference} alt=""/>


                    <div className={"ml-[450px] mt-[-400px]  "}>
                        <h3 className={"ml-[-18px]"}>Office for main team</h3>
                        <h2 className="text-[30px] text-[#2D2D2D] mt-1 sm:text-[30px] ml-[-20px]">5 000 000 uzs<span
                            className="text-[#797979] text-[20px] sm:text-[18px]">/Month </span></h2>


                        <div className="w-[300px] h-[50px] flex mt-4 ml-[-20px] ">


                            <div className="w-[1500px] gap-4 h-[50px] flex flex-col ">
                            ...
                            <br/>
                            <div className="w-[200px] gap-4 h-[50px] flex flex-col  ">
                                <h3 className="w-[200px] flex items-center gap-2 text-[12px] text-[#797979]"><img
                        ...
                        <div className={"w-auto h-auto flex gap-4 pt-2 ml-[-15px] mt-[80px] "}>
                        ...
                        <p className={"text-[12px] w-[250px] ml-[-13px]"}>A professional on-demand office space. Perfect
                            when you
                            need to get your head down and do
                            your best work</p>

                        <button
                            className="   w-[127px] mt-[20px] ml-[-13px]  h-[35px] bg-[#373737] rounded-[90px] text-white text-[10px]  ">
                            BOOKING ROOM
                        </button>
                    </div>
                </div>
                <div data-aos='zoom-out-up' className="w-[843px] h-[447px] bg-white ml-[490px] mt-10 rounded-[20px] ">
                    ...
                    <div className={"ml-[450px] mt-[-400px]  "}>
                        <h3 className={"ml-[-18px]"}>Office for main team</h3>
                        <h2 className="text-[30px] text-[#2D2D2D] mt-1 sm:text-[30px] ml-[-20px]">8 000 000 uzs<span
                            className="text-[#797979] text-[20px] sm:text-[18px]">/Month </span></h2>
                ...
                <div data-aos='zoom-out-up' className="w-[843px] h-[447px] bg-white ml-[490px] mt-10 rounded-[20px] ">
                    ...
                    <div className={"ml-[450px] mt-[-400px]  "}>
                        <h3 className={"ml-[-18px]"}>Office for main team</h3>
                        <h2 className="text-[30px] text-[#2D2D2D] mt-1 sm:text-[30px] ml-[-20px]">22 000 000 uzs<span
                            className="text-[#797979] text-[20px] sm:text-[18px]">/Month </span></h2>
            ...
            <div data-aos='fade-up' className={"w-full h-screen flex justify-center items-center relative mt-[-250px] bg-[#EBEBEB]"}
