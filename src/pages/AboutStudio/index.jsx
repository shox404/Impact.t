...
export default function Index() {
    return (
        <div className='w-full h-auto bg-[#EDEDED] xl:container mx-auto'>
            ...
            <h1 className='lg:text-[60px] text-[90px] text-[#2D2D2D] w-10/12 leading-none m-auto text-center'>Impact Studio coworking
            ...
            <div className='pt-24 px-12 sm:px-8'>
                <h1 className='text-6xl sm:text-3xl sm:text-pretty lg:text-center leading-tight text-[#2D2D2D]  text-pretty'> <span className='pl-14 md:pl-0 lg:pl-0 sm:pl-0'>Our</span> new creative space - Impact.t Studio!
                    Here we will bring together art lovers, creative individuals and entrepreneurs for collaboration  and  inspiration</h1>
                <p className='text-[#2D2D2D] w-3/12 lg:w-8/12 text-justify m-auto pt-24'>Every corner of our space is imbued with an atmosphere of freedom. At Impact.t Studio you will be able to attend events, attend artist exhibitions, participate in networking and exchange ideas, and work in comfortable and functional offices.</p>
                <p className='text-[#2D2D2D] w-3/12 lg:w-8/12 text-justify m-auto pt-14'>From Impact.t Studio, you will not only have a comfortable office with all the conditions, but also witness various useful activities.
            ...
            <div className='px-12 pt-32'>
                <h4 className='text-4xl sm:text-3xl sm:text-center text-[#2D2D2D]'>
            ...
            <div className='w-full py-24 px-12 sm:px-5 lg:px-14 flex gap-5 sm:flex-wrap lg:flex-wrap'>
                ...
                <div className='w-auto h-auto bg-[#2D2D2D] px-10 pr-24 py-10 rounded-3xl sm:rounded-xl'>
